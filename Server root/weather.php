...
if ($lat === "0" && $long === "0") {
	...
	$weather_data = file_get_contents("http://127.0.0.1/assets/php/get-weather.php?lat={$lat}&long={$long}&VIN={$VIN}");
}
...
<tr>
<td class="temp act"><?php echo $weather_data->now_temperature; ?></td>
...
<tr>
<td class="act"><img src="/assets/img/weather-col/<?php echo str_replace(' ', '-', $weather_data->now_condition); ?>.png" alt=""></td>
